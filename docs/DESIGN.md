...
> This is the working record of how mole was built: every decision, what was
> measured, what was got wrong and how it was found. It is deliberately not a
> product README — that is [../README.md](../README.md).
>
> It is kept because the arguments here are the reason the code looks the way it
> does, and because several of the numbers quoted in the README are only
> interpretable next to the method that produced them.
